...
Config.PenalCode = {
    ...
    [2] = {
        ...
        [5] = {title = 'Armed Robbery', class = 'Indictable offence', id = 'Section 8 Theft Act 1968', months = 35, fine = 3500, color = 'red', description = 'Stealing from a person or businesss with the use or threat of force while carrying or using a weapon'},
        [6] = {title = 'Handling Stolen Goods', class = 'Either way offence', id = 'Section 22 Theft Act 1968', months = 10, fine = 500, color = 'green', description = 'Receiving or disposing of stolen goods knowing or believing them to be stolen'},
        [7] = {title = 'Aggravated Vehicle Taking', class = 'Indictable offence', id = 'Section 12A Theft Act 1968', months = 15, fine = 900, color = 'green', description = 'Taking a vehicle without consent and causing damage or injury'},
        [8] = {title = 'Taking Without Owner’s Consent', class = 'Either way offence', id = 'Section 12 Theft Act 1968', months = 8, fine = 600, color = 'green', description = 'Taking a conveyance without the owner’s consent or other lawful authority'},
        [9] = {title = 'Making off Without Payment', class = 'Either way offence', id = 'Section 3 Theft Act 1978', months = 0, fine = 500, color = 'green', description = 'Leaving a place where payment is required without paying and with intent to avoid payment'},
    },
    [3] = {
